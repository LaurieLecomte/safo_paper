...
# srun -p small -c 4 --time=1-00:00:00 -J mosdepth -o log/mosdepth_SR_on_SaFo_%j.log /bin/sh 01_scripts/depth.sh "wgs_sample_preparation/06_aligned/SaFo_cat_1.trimmed.sorted.bam" &
