...
# Run on Manitou
# srun -p medium -c 6 --mem=50G --time=7-00:00:00 -J 04.2_RepeatMasker_chrs_SaNa -o log/04.2_RepeatMasker_chrs_SaNa_%j.log /bin/sh 01_scripts/04.2_RepeatMasker_chrs_SaNa.sh &
...
## Index
#samtools faidx $SANA
## Make bed and extract chr: Remove unplaced contigs (starting with scaf), and remove mitochondrion (CM028292.1)
...
RepeatMasker -pa $CPU $SYN_DIR/query_SaNa.chrs_noMt_renamed.fasta -dir $SYN_DIR -gff -lib $SAFO_SALMO_LIB
